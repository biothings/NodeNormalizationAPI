...
class TestNodeNormalizationHandler(AsyncHTTPTestCase):
    ...
    def test_node_normalization_get(self):
        ...
        """
        normalized_nodes_endpoint = r"/get_normalized_nodes"
    ...
    def test_node_normalization_post(self):
        ...
        normalized_nodes_endpoint = r"/get_normalized_nodes"
        url = self.get_url(normalized_nodes_endpoint)
        body = json.dumps({"curies": ["MESH:D014867", "NCIT:C34373"]})
        ...
        expected_body = {
            ...
            "NCIT:C34373": {
                ...
                "equivalent_identifiers": [
                    {"identifier": "MONDO:0004976", "label": "amyotrophic lateral sclerosis"},
                    {"identifier": "DOID:332", "label": "amyotrophic lateral sclerosis"},
                    {"identifier": "orphanet:803"},
                    {"identifier": "UMLS:C0002736", "label": "Amyotrophic Lateral Sclerosis"},
                    {"identifier": "MESH:D000690", "label": "Amyotrophic Lateral Sclerosis"},
                    {"identifier": "MEDDRA:10002026"},
                    {"identifier": "MEDDRA:10052889"},
                    {"identifier": "MEDDRA:10090869"},
                    {"identifier": "NCIT:C34373", "label": "Amyotrophic Lateral Sclerosis"},
                    ...
                    {"identifier": "HP:0007354", "label": "Amyotrophic lateral sclerosis"},
                ],
                "type": [
                    "biolink:Disease",
